...
::: {.codewindow .html}
index.html
<iframe class="slide-deck" src="_example.html" style="width: 100%; height: 484.47px;"></iframe>
:::
:::
:::
...
::: {.codewindow .quarto}
index.qmd
{{< include _example_styles_include.qmd >}}
:::
...
<iframe class="slide-deck" src="_example_colors.html" style="width: 100%; height: 484.47px;"></iframe>
:::
:::
:::
...
<iframe class="slide-deck" src="_example_fonts.html" style="width: 100%; height: 484.47px;"></iframe>
:::
:::
:::
...
<iframe class="slide-deck" src="_example_sizes.html" style="width: 100%; height: 484.47px;"></iframe>
:::
:::
:::
